<?php
/**
 * NggicbAdminPanel - Admin Section for Image Chooser Block for NextGEN Gallery
 * 
 * @package NextGEN Gallery Image Chooser
 * @author Ulrich Mertin
 * @license    http://www.gnu.org/licenses/gpl-2.0.html GPL Version 2
 */
class NggicbAdminPanel{
	...
	function __construct() {
		...
		// get the options
		$this->options = get_option('nggicb_options');
  }

	// integrate the menu	
	function add_menu()  {
	    add_options_page('Image Chooser Block for NextGEN Gallery', 'Image Chooser Block for NextGEN Gallery', 'manage_options', 'nggicb-options', array (&$this, 'show_menu') );
	...
	static function render_message ($message, $timeout = 0)
	{
		?>
		<div class="wrap"><h2>&nbsp;</h2>
